	...
	<div class="md:flex min-h-screen">
		<div class="w-full md:w-1/2 flex items-center justify-center">
			<div class="max-w-sm m-8">
				...
				<p class="text-gray-800 text-2xl md:text-3xl font-light mb-8"><?php _e( 'Sorry, the page you are looking for could not be found.', 'darkwind' ); ?></p>
				<a href="<?php  echo esc_url( home_url() ); ?>" class="bg-primary px-4 py-2 rounded text-white">
					<?php _e( 'Go Home', 'darkwind' ); ?>
				</a>
			</div>
		</div>
	</div>
